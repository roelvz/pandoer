    ...
    constructor(props) {
        ...
        for (let i = 1; i <= 14; i++) {
            ...
            switch (i) {
                ...
                default: rank = i.toString(); break;
            }
            this.state.cardRefs[rank + 'h'] = React.createRef();
            this.state.cardRefs[rank + 'c'] = React.createRef();
            this.state.cardRefs[rank + 's'] = React.createRef();
            this.state.cardRefs[rank + 'd'] = React.createRef();
        }
    }
